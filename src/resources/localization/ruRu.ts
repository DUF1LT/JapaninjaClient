export const ruRu = {
    ...
    yourOrderIsAccepted: 'Ваш заказ принят!',
    ...
    closed: 'Закрыт',
    canceled: 'Отменен',
    thereAreNoOrders: 'Заказы не найдены',
    client: 'Заказчик',
    cancel: 'Отменить',
    process: 'Обработать',
    setToReady: 'Готов',
    ship: 'Взять в доставку',
    deliver: 'Доставить',
    close: 'Закрыть',
    ...
    enterHouseNumber: 'Введите номер дома',
    enterFlat: 'Введите квартиру',
