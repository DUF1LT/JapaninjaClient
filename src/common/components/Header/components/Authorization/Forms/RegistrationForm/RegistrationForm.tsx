...
const validationSchema = Yup.object({
    [RegisterFormFields.Email]: Yup.string().email(localization.pleaseEnterValidEmail).required(localization.pleaseEnterEmail),
    [RegisterFormFields.Password]: Yup.string().required(localization.pleaseEnterPassword)
    ...
    [RegisterFormFields.RepeatPassword]: Yup.string()
        .required(localization.pleaseRepeatPassword)
